...
- مسموح إيموجي واحد كحد أقصى لكل رسالة (يفضّل صفر بأغلب الردود).
- ممنوع تكتلات الإيموجي (🍔🥤📍) — إيموجي واحد فقط أو لا شيء.
...
- صفر إيموجي افتراضياً. مسموح إيموجي واحد فقط في رسالة الترحيب الأولى أو تأكيد نهائي ناجح — وليس بكل رسالة.
- ممنوع تكتلات الإيموجي (مثل 🍔🥤📍 معاً) بأي رسالة.
- ممنوع الإيموجي نهائياً في: ملخّص الطلب، المعاينة، الفاتورة، طلب البيانات (اسم/عنوان/هاتف)، رسائل الخطأ والاعتذار.
